define([
    ...
    'scripts/plugins/settings',
     ...
     var cur_power=-1;
     //在家/离家
     var cur_home=-1,address='',weather='',tmp='',hum='',wind_sc='',cond_code='';//add by jiangzhiwei
     //当前设定温度
            ...
            $.ajax({
                ...
                success:function (res) {
                    ...
                    try{
                        ...
                        //add by jiangzhiwei
                        cond_code=res.HeWeather6[0].now.cond_code||100;
                        wind_sc=res.HeWeather6[0].now.wind_sc;
                        tmp=res.HeWeather6[0].now.tmp;
                        hum=res.HeWeather6[0].now.hum;
                        console.log("jiangzhiwei-"+cond_code);
                        console.log("jiangzhiwei-"+wind_sc);
                        console.log("jiangzhiwei-"+tmp);
                        console.log("jiangzhiwei-"+hum);
                    }catch (e) {
