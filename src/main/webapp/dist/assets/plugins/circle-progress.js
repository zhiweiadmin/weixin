...
(function($) {
   ...
   //     size: 250.0,
         ...
         * @type {string}
         */
        emptyFill: 'rgba(255, 255, 225, 0.1)',
        ...
        drawArc: function(v) {
            ...
            if (!this.reverse) {
                ctx.arc(r, r, r - t / 2-10, a, a + Math.PI * 2 * v *va);
            } else {
                ctx.arc(r, r, r - t / 2-10, a - Math.PI * 2 * v, a);
            }
        ...
        drawEmptyArc: function(v) {
            ...
            if (v < 1) {
                ...
                ctx.beginPath();
                if (v <= 0) {
                    ctx.arc(r, r, r - t / 2-10, a-0.05, a-Math.PI *2.02*v);
                } else {
                    if (!this.reverse) {
                        ctx.arc(r, r, r - t / 2-10, a - 0.05, a + Math.PI*2.02*v);
                    } else {
                        ctx.arc(r, r, r - t / 2-1, a, a - Math.PI * v);
                    }
                }
                ctx.lineWidth = t+3;
